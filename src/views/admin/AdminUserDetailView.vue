      ...
      <div class="grid items-start gap-5 xl:grid-cols-[420px_1fr]">
        ...
        <div class="rounded-2xl border border-slate-100 bg-white shadow-sm">
          ...
          <div v-else class="grid gap-4 p-4 sm:grid-cols-[repeat(auto-fill,minmax(340px,380px))]">
            ...
            >
              <span class="mb-3 flex items-start justify-between gap-3">
                <span class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
