  ...
  <div class="space-y-5">
      ...
      >
        ...
        <div class="flex gap-2 ml-auto flex-wrap">
          ...
          <button
              ...
              class="px-3 py-2 rounded-lg text-sm text-slate-500 hover:bg-white border border-transparent hover:border-slate-200"
          >
            Bekor
          </button>
        </div>
    ...
    <template v-else>
      ...
      <div v-else class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          >
            ...
            >
              <input
                  ...
                  class="mt-1 shrink-0 rounded border-slate-300 text-primary-600"
              />
              <button
              ...
              >
                ...
                <p class="mt-1 truncate text-xs text-slate-500">
                  {{ ownerName(biz) }} · {{ biz.contactPhone || 'Telefon yo‘q' }}
                </p>
              </button>
              <span
            ...
            >
              <p class="truncate text-xs text-slate-500">
                {{ categoryLabel(biz.category) }} · {{ formatDate(biz.subscriptionEndDate) }}
              </p>
              <div class="flex shrink-0 gap-1">
                ...
                <button
                    ...
                    class="rounded-lg p-1.5 text-indigo-600"
                    title="Holat"
                >
            ...
            <tbody class="divide-y divide-slate-50">
              ...
              >
                ...
                <td class="px-3 py-3.5 text-slate-500 text-xs">
                  {{ formatDate(biz.trialEndDate) }}
                </td>
                <td class="px-3 py-3.5 text-slate-500 text-xs">
                  {{ formatDate(biz.subscriptionEndDate) }}
                </td>
        ...
        <div
            v-if="totalPages > 1"
            class="px-5 py-4 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3"
        >
