      ...
      <div>
        ...
        <div class="flex gap-2">
          <input
            ...
            class="flex-1 px-2 py-1.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500"
            @blur="searchPhone"
            @input="resetCustomer"
...
<!--          </button>-->
      ...
      <div>
        ...
        <input
          ...
          type="date"
          :min="todayIso()"
          class="w-full px-2 py-1.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500"
        />
      </div>
      <div>
